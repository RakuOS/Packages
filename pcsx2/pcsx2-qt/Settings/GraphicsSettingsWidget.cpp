	...
	, m_dialog(dialog)
{
	...
	connectCheckStateChanged(m_ui.shadeBoost, this, &GraphicsSettingsWidget::onShadeBoostChanged);
	onShadeBoostChanged();
	...
	connectCheckStateChanged(m_ui.gpuPaletteConversion, this, &GraphicsSettingsWidget::onGpuPaletteConversionChanged);
	...
	connectCheckStateChanged(m_ui.dumpReplaceableTextures, this, &GraphicsSettingsWidget::onTextureDumpChanged);
	connectCheckStateChanged(m_ui.loadTextureReplacements, this, &GraphicsSettingsWidget::onTextureReplacementChanged);
	...
	connectCheckStateChanged(m_ui.enableHWFixes, this, &GraphicsSettingsWidget::updateRendererDependentOptions);
	connectCheckStateChanged(m_ui.extendedUpscales, this, &GraphicsSettingsWidget::updateRendererDependentOptions);
	...
	// Capture settings
	{
		...
		connectCheckStateChanged(m_ui.enableVideoCapture, this, &GraphicsSettingsWidget::onEnableVideoCaptureChanged);
		connectCheckStateChanged(
			m_ui.videoCaptureResolutionAuto, this, &GraphicsSettingsWidget::onVideoCaptureAutoResolutionChanged);
		connectCheckStateChanged(m_ui.enableVideoCaptureArguments, this,
		...
		connectCheckStateChanged(m_ui.enableAudioCapture, this, &GraphicsSettingsWidget::onEnableAudioCaptureChanged);
		connectCheckStateChanged(m_ui.enableAudioCaptureArguments, this,
