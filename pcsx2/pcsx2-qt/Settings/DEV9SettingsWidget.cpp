	...
	, m_dialog{dialog}
{
	...
	connectCheckStateChanged(m_ui.ethEnabled, this, &DEV9SettingsWidget::onEthEnabledChanged);
	...
	connectCheckStateChanged(m_ui.ethInterceptDHCP, this, &DEV9SettingsWidget::onEthDHCPInterceptChanged);
	...
	connectCheckStateChanged(m_ui.ethNetMaskAuto, this, [&](Qt::CheckState state) { onEthAutoChanged(m_ui.ethNetMaskAuto, state, m_ui.ethNetMask, "DEV9/Eth", "AutoMask"); });
	...
	connectCheckStateChanged(m_ui.ethGatewayAuto, this, [&](Qt::CheckState state) { onEthAutoChanged(m_ui.ethGatewayAuto, state, m_ui.ethGatewayAddr, "DEV9/Eth", "AutoGateway"); });
	...
	// HDD Settings
	//////////////////////////////////////////////////////////////////////////
	connectCheckStateChanged(m_ui.hddEnabled, this, &DEV9SettingsWidget::onHddEnabledChanged);
	...
	connectCheckStateChanged(m_ui.hddLBA48, this, &DEV9SettingsWidget::onHddLBA48Changed);
